...
1. RHEL 9 is essential to initiate the squid proxy deployment process.

2. Generate and copy the ssh keys from ansible engine/installer machine to all the remote hosts.
